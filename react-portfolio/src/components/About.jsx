...
return (
    <section id="about" className="flex flex-col-reverse md:flex-row items-center gap-12 py-16">
        ...
        <div className="w-48 h-48 md:w-64 md:h-64 rounded-2xl overflow-hidden border-4 border-indigo-200 dark:border-indigo-800 shrink-0 shadow-lg mx-auto md:mx-0">
